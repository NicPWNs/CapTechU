...
void TreeType::PrintInOrder()
{
	PrintInOrder(root);
}

void TreeType::PrintInOrder(TreeNode* node)
{
	if (node == NULL)
		return;
...
void TreeType::PrintPreOrder()
{
	PrintPreOrder(root);
}

void TreeType::PrintPreOrder(TreeNode* node)
{
	if (node == NULL)
		return;
...
void TreeType::PrintPostOrder()
{
	PrintPostOrder(root);
}

void TreeType::PrintPostOrder(TreeNode* node)
{
	if (node == NULL)
		return;
